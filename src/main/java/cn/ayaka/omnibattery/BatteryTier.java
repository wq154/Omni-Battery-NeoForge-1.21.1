 ...
 * rates: 5 档传输速率 (FE/t)；rangeSteps: 可选范围档位；ULTIMATE 的 -1 表示全维度。
 */
public enum BatteryTier {
    LOW("\u4f4e\u7ea7", 10000000000L, 16, new int[]{1000000, 5000000, 10000000, 25000000, 50000000}, new int[]{8, 12, 16}),
    MEDIUM("\u4e2d\u7ea7", 100000000000L, 32, new int[]{5000000, 10000000, 25000000, 50000000, 100000000}, new int[]{12, 18, 24, 32}),
    ADVANCED("\u9ad8\u7ea7", 1000000000000L, 96, new int[]{10000000, 50000000, 100000000, 250000000, 500000000}, new int[]{16, 32, 48, 64, 96}),
    ELITE("\u7cbe\u82f1", 100000000000000L, 256, new int[]{50000000, 100000000, 250000000, 500000000, 1000000000}, new int[]{32, 64, 128, 192, 256}),
